...
export function writeDayPage({ yongsanKeywords = [], mergeKeywords = [], mergeLabel = '중고 농구', shortDays = 1, longDays = 7, longKeywords = [], order = [] } = {}) {
  ...
  const { subject, html } = buildNewsEmail(news, { yongsanKeywords, order });
  const page = html
